...
class HeatApp:
    def __init__(self, main):
        ...
        self.L_var = self.add_spin("Длина L (м)", 0.1, 10, 0.1, 0.1)
        self.T0_var = self.add_spin("Начальная T₀", -50, 200, 1, 0)
        self.TL_var = self.add_spin("T слева", -50, 300, 1, -10)
        self.TR_var = self.add_spin("T справа", -50, 300, 1, 50)
        self.tend_var = self.add_spin("Время моделирования", 0.1, 20, 0.1, 10.0)
